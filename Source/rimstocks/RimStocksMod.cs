...
namespace rimstocks
{
    public class RimstocksMod : Mod
    {
        ...
        public override string SettingsCategory()
        {
            ...
            return "YayosBank_ModName".Translate();
        }
        ...
        public override void DoSettingsWindowContents(UnityEngine.Rect inRect)
        {
            ...
            listing.ColumnWidth = inRect.width - 16f;

            
            // Section 1: simple booleans / restart-required items
            listing.CheckboxLabeled("useEnemyFaction".Translate(), ref SettingsInstance.useEnemyFaction,
                "RequiresRestart".Translate());
            listing.CheckboxLabeled("useVanillaEnemyFaction".Translate(), ref SettingsInstance.useVanillaEnemyFaction,
                "RequiresRestart".Translate());

            // Integers / floats (limitDate)
            listing.Label("limitDate.t".Translate(), tooltip: "limitDate.d".Translate());
            SettingsInstance.limitDate = (int)Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.limitDate, 1f, 3650f, true, SettingsInstance.limitDate.ToString(), null, null, 1f);
            ...
            listing.Label("rimwarPriceFactor.t".Translate() + ": " + SettingsInstance.rimwarPriceFactor.ToString("0.##"), tooltip: "rimwarPriceFactor.t".Translate());
            SettingsInstance.rimwarPriceFactor = Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.rimwarPriceFactor, 0f, 2f, true, SettingsInstance.rimwarPriceFactor.ToString("0.##"), null, null);

            listing.Gap(6f);

            // Price & dividend settings
            listing.Label("sellPrice.t".Translate() + ": " + SettingsInstance.sellPrice.ToString("0.00"));
            SettingsInstance.sellPrice = Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.sellPrice, 0.01f, 1f, true, SettingsInstance.sellPrice.ToString("0.00"), null, null);

            listing.Label("dividendPer.t".Translate() + ": " + SettingsInstance.dividendPer.ToString("0.00"), tooltip: "dividendPer.t".Translate());
            SettingsInstance.dividendPer = Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.dividendPer, 0f, 5f, true, SettingsInstance.dividendPer.ToString("0.00"), null, null);

            listing.Label("maxReward.t".Translate() + ": " + SettingsInstance.maxReward.ToString("0"), tooltip: "maxReward.d".Translate());
            SettingsInstance.maxReward = Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.maxReward, 0f, 500000f, true, SettingsInstance.maxReward.ToString("0"), null, null);

            listing.Label("DelistingPrice.t".Translate() + ": " + SettingsInstance.DelistingPrice.ToString("0"), tooltip: "DelistingPrice.d".Translate());
            SettingsInstance.DelistingPrice = Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.DelistingPrice, 1f, 1000f, true, SettingsInstance.DelistingPrice.ToString("0"), null, null);

            listing.Gap(6f);

            // military aid & price event
            listing.Label("militaryAid_cost.t".Translate() + ": " + SettingsInstance.militaryAid_cost, tooltip: "militaryAid_cost.d".Translate());
            SettingsInstance.militaryAid_cost = (int)Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.militaryAid_cost, 0f, 100f, true, SettingsInstance.militaryAid_cost.ToString(), null, null);

            listing.Label("militaryAid_multiply.t".Translate() + ": " + SettingsInstance.militaryAid_multiply.ToString("0.##"), tooltip: "militaryAid_multiply.d".Translate());
            SettingsInstance.militaryAid_multiply = Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.militaryAid_multiply, 0f, 10f, true, SettingsInstance.militaryAid_multiply.ToString("0.##"), null, null);

            listing.Label("priceEvent_multiply.t".Translate() + ": " + SettingsInstance.priceEvent_multiply.ToString("0.##"), tooltip: "priceEvent_multiply.d".Translate());
            SettingsInstance.priceEvent_multiply = Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.priceEvent_multiply, 0f, 10f, true, SettingsInstance.priceEvent_multiply.ToString("0.##"), null, null);

            listing.Gap(6f);

            // Loans
            listing.Label("loanDate.t".Translate() + ": " + SettingsInstance.loanDate);
            SettingsInstance.loanDate = (int)Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.loanDate, 1f, 3650f, true, SettingsInstance.loanDate.ToString(), null, null);

            listing.Label("loanPer.t".Translate() + ": " + SettingsInstance.loanPer.ToString("0.00"));
            SettingsInstance.loanPer = Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.loanPer, 0f, 1f, true, SettingsInstance.loanPer.ToString("0.00"), null, null);

            listing.Label("loanScale.t".Translate() + ": " + SettingsInstance.loanScale, tooltip: "loanScale.d".Translate());
            SettingsInstance.loanScale = (int)Widgets.HorizontalSlider(listing.GetRect(22f), SettingsInstance.loanScale, 0f, 1000000f, true, SettingsInstance.loanScale.ToString(), null, null);
